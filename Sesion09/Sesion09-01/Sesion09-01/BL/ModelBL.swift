...
class ModelBL {
    ...
    class func create(name: String?, releaseYear: String?, type: String?, success: Create, error: ErrorMessage) {
        ...
        let objDM = ModelDA.create(name: safeName, releaseYear: safeReleaseYear, type: safeType, context: context)
